        ...
        child: ListView(
          children:[
            ...
            TextButton(
                ...
                child: Text(' Get Started Now ', style:TextStyle(backgroundColor: Colors.orange,color:Colors.white,fontSize: 20,)),
                onPressed: () {
            ...
            TextButton(
                ...
                child: Text(' Test Me here ', style:TextStyle(backgroundColor: Colors.orange,color:Colors.white,fontSize: 20,)),
                onPressed: () {
                  print('test');
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => ReplaceName()),
                  );
...
class GettingStarted extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("DinfoSEASE Homepage ",style:TextStyle(fontSize: 17)),
        backgroundColor: Colors.orange,
        centerTitle:true,
      ),
      body: Center(
...
class ReplaceName extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
