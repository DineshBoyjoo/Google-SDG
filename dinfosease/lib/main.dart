        ...
        return Scaffold(
          ...
          body: Center(
            ...
            child: ListView(
              ...
              Text("\n"),
                Text("Welcome to DinfoSEASE",style: TextStyle(fontSize: 23),textAlign: TextAlign.center,),

                SizedBox(height: 10),
                Text("Your health companion platform to access disease statistics in Mauritius and up to date preventive measures.",textAlign: TextAlign.center,style:TextStyle(fontSize: 17)),
