      ...
      body: Center(
          ...
          child: ListView(
              ...
              children: [
                ...
                Text("Accessing from : ",style: TextStyle(fontSize: 16,fontWeight: FontWeight.bold,),),
                ...
                Text("Stats about Mauritius",style: TextStyle(fontSize: 16,fontWeight: FontWeight.bold,),),
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceAround ,
                  children:[
                ...
                SizedBox(height: 10),
                Text(" Active Disease Dashboard",style: TextStyle(fontSize: 16),textAlign: TextAlign.center,),
